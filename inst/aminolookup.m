...
%!assert (isequal(aminolookup(code), abbr))
%!assert (isequal(aminolookup(abbr), code))
%!assert (isequal(aminolookup(ints), code))
%!assert (isequal(aminolookup('Code', 'R'), 'Arg Arginine'))
%!assert (isequal(aminolookup('Integer', 1), 'A Ala Alanine'))
%!assert (isequal(aminolookup('Abbreviation', 'asn'), 'N Asparagine'))
%!assert (isequal(aminolookup('Name', 'proline'), 'P Pro'))
